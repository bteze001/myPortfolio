      ...
      {/* {showLoader ? (
        ...
        <>
          ...
          <Routes location={location} key={location.pathname}>
            ...
            <Route path="/about" element={<AboutMe  brand={personalDetails.brand}/>}/>
            <Route path="/portfolio" element={<Portfolio />} />
            <Route path="/skills" element={<Skills brand={personalDetails.brand}/>} />
